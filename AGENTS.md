...
- Always update the test for the desired outcome prior to making the code change.
- Always run the test after a code change to validate the change.
- Always run the linter checks after every code change.